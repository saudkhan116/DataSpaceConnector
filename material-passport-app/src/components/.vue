  ...
  <div class="section-content">
    ...
    <div class="sub-section-container">
      <div class="field-container">
        ...
        <span class="field-value"
          >L:{{ generalInformation.dimensions.length }}, H:{{
            generalInformation.dimensions.height
          }}, W:{{ generalInformation.dimensions.width }}</span
        >
      </div>
      <div class="field-container">
        <span class="field-label">Weight of the battery</span>
        <span class="field-value">{{ generalInformation.weight }}</span>
      </div>
      <div class="field-container">
        <span class="field-label">Date of Manufacture</span>
        <span class="field-value">{{
          generalInformation.manufacuringDate
        }}</span>
      </div>
      <div class="field-container">
      ...
      <div class="field-container">
        ...
        <span class="field-value">{{
          generalInformation.placedToMarketDate
        }}</span>
      </div>
      <div class="field-container">
        <span class="field-label"></span>
      ...
      <div class="field-container">
        ...
        <span class="field-value">{{
          generalInformation.co2.co2FootprintTotalKG
        }}</span>
      </div>
    </div>
  </div>
